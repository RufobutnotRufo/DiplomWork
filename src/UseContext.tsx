...
interface MyContextType {
  ...
  descriptionData: Movie;
  setDescriptionData: (descriptionData: Movie) => void;
}
...
export const MyContextProvider: React.FC<MyContextProviderProps> = ({
  ...
  const [registredUsers, setRegistredUsers] = useState<UserInterface[]>([
    {
      name: "god",
      surname: "godMode",
      email: "1",
  ...
  // По скольку оказалось что на запрос этого API можно делать ограниченное кол раз пришлось вручную все рендерить
  // хорошо что я сделал копии да ? какой я молодец
  //только вспомнил что надо коменты вставлять поэтому их будет много
  //да знаю что коменты пишут для того чтобы ктото разбирался в коде но никто все равно не будет здесь копаться
...
//       method: "GET",
//       headers: {
//         "x-rapidapi-key": "8948f4a394msh77480a9998c5a38p1f9b14jsnc060719b4cdc",
